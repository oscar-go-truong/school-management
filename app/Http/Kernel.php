...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'has.exam' => \App\Http\Middleware\EnsureUserHasExam::class,
        'has.subject' => \App\Http\Middleware\EnsureUserHasSubject::class,
        'has.request' => \App\Http\Middleware\EnsureUserHasRequest::class,
