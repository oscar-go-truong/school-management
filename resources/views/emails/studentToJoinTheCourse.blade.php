...
<body class="bg-gray-100">
    <div class="container mx-auto my-10 p-5 bg-white rounded-lg shadow-md">
        ...
        <p class="text-gray-700 text-base leading-7 mb-6">I am writing to inform you that you have been successfully
            enrolled in {{ $course->subject->name }}
            {{ $course->name }}. Congratulations on your enrollment!</p>
